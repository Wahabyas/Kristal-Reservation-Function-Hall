...
<!--  -->
		...
		<?php include('includes/header.php'); ?>
			...
			<main class="content">
				<div class="container-fluid p-0">
					...
					<h1 class="h3 mb-3">  <strong>My Booking</strong></h1>

					<?php
    $conn = new class_model();
	$my_id = $_SESSION['Customer_id'];

    $mybooking = $conn->fetchAll_MyBooking($my_id);
    ?>
  ...
  <div class="row">
    ...
    <div class="col-lg-3">
	<select id="sortDateBooked" class="form-select w-auto">
      <option selected disabled>Sort by Date Booked</option>
      ...
      <option value="desc">Newest First</option>
			...
			<table class="table table-hover my-5"  id="statusTable">
				<thead>
					<tr>
	...
	<td><?= htmlspecialchars($row['code']) ?></td>
								...
								<td >
												<?php if($row['Status']== "Approved") {?>
								<a href="receipt.php?event=<?= $row['id']; ?>&event-name=<?php echo $row['events']; ?>" class="text-secondary font-weight-bold text-xs" data-toggle="tooltip" title="Paid Invoice">
									<i class="align-middle me-2" data-feather="user-check"></i>
											</a>
				
										<?php }elseif($row['Status']== "Declined"){ ?>
											<a href="apology.php?event=<?= $row['id']; ?>&event-name=<?php echo $row['events']; ?>" class="text-secondary font-weight-bold text-xs" data-toggle="tooltip" title="Mail">
	...
	<?php }elseif($row['Status']== ""){ 
									...
									?>
											...
											<a href="javascript:;" data-id="<?= $row['id']; ?>" class="text-secondary font-weight-bold text-xs cancel " data-toggle="tooltip" title="Cancel">
												<i style='text-decoration:none;' class="align-middle me-2" data-feather="slash"></i>
												</a> 
									...
									?>
										...
										<a href="Expired.php?event=<?= $row['id']; ?>&event-name=<?php echo $row['events']; ?>" class="text-secondary font-weight-bold text-xs" data-toggle="tooltip" title="Invoice">
	 ...
	 <?php }elseif($row['Status']== "Payable"){ ?>
									...
									<a href="receipt.php?event=<?= $row['id']; ?>&event-name=<?php echo $row['events']; ?>" class="text-secondary font-weight-bold text-xs" data-toggle="tooltip" title="Unpaid Invoice">
									<i class="align-middle me-2" data-feather="file-text"></i> <span class="align-middle"></span>
												</a>
...
<script>
  document.getElementById("sortDateBooked").addEventListener("change", function () {
