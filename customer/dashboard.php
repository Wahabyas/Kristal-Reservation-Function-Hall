...
<!--  -->
		...
		$Count = $conn-> count_NOofmybooking($my_id);
		$Countoftran = $conn-> Count_totaltrans($my_id);
		$totalofmoneytrans = null;
									...
									<div class="col-sm-6">
										<div class="card">
											<div class="card-body">
												<div class="row">
													<div class="col mt-0">
														<h5 class="card-title">Number of My Booking</h5>
													</div>
												...
												<h1 class="mt-1 mb-3"><?php foreach ($Count as $row){
													
													echo $row['count_Booking'];
												}?></h1>
												<div class="mb-0">
									...
									<div class="col-sm-6">
										<div class="card">
											<div class="card-body">
												<div class="row">
													<div class="col mt-0">
														<h5 class="card-title">Total of Money Transaction</h5>
													</div>
												...
												foreach($Countoftran as $row){
													$totalofmoneytrans+= $row['Amount'];
												}
												if($totalofmoneytrans){
												echo " " .$totalofmoneytrans;
												}else{
													echo " 0 ";
												}
												?></h1>
