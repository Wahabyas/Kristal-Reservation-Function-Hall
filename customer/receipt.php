...
<body>
  <div class="invoice-box">
    ...
    <div class="section">
      ...
      <strong>Payment Status:</strong> <?php  if($row['Status'] == 'Approved'){  ?> <em>Fully Paid</em> <?php }else{?><em style="color: red;">Not yet Paid</em><?php } ?>
    </div>
        ...
        <tfoot>
         <?php  $total= $Cmoney - $Smoney; ?>
          ...
          <tr>
            ...
            <th class="text-right"><strong><?php  if($row['Status'] == 'Approved'){  ?><em><?= $total ?>.00</em><?php }else{?> <em style="color: red;padding:2px;"><?= $total ?>.00</em><?php } ?></strong></th>
          </tr>
        </tfoot>
      </table>
    </div>
