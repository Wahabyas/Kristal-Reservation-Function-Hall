...
<button onclick="location.href='Add_Users.php'"  class="btn btn-primary btn-lg pl-2 pr-4">ADD Staff</button>
<?php }else{} ?>
</div>
</div>
                        ...
                        <?php if (!empty($booking)) {
                            foreach ($booking as $row) { ?>
                                <tr>
									...
									<td >
									<?php if($row['Status']== 1){ ?> 
									<a href="javascript:;" data-id="<?= $row['User_id']; ?>" class="text-secondary font-weight-bold text-xs actived" data-toggle="tooltip" title="Deactivated">
                                       
									<i class="align-middle me-2" data-feather="zap-off"></i>
									 </a>
									 <a href="edit_user.php?user_id=<?= $row['User_id']; ?>&User-name=<?= $row['Username']; ?>" class="text-secondary font-weight-bold text-xs" data-toggle="tooltip" title="Edit user">
                                                        <i  class="align-middle me-2" data-feather="edit"></i>
                                            </a>
									<?php }elseif($row['Status']== 0){ ?>
										<a href="javascript:;" data-id="<?= $row['User_id']; ?>" class="text-secondary font-weight-bold text-xs deactive" data-toggle="tooltip" title="Activate">
									   ...
									   <i class="align-middle me-2" data-feather="zap"></i>
										...
										if($row['role'] == 'Staff'){ ?>
												...
												<a href="javascript:;" data-id="<?= $row['User_id']; ?>" class="text-secondary font-weight-bold text-xs delete" data-toggle="tooltip" title="delete User">
    ...
    $(document).ready(function() {
        ...
        function load_data() {
            $(document).on('click', '.actived', function() {
                ...
                if (confirm("Are you sure want to Deactivate this Account?")) {
                    $.ajax({
                        url: 'controllers/activate_user1.php',
    ...
    $(document).ready(function() {
        ...
        function load_data() {
            $(document).on('click', '.deactive', function() {
                ...
                if (confirm("Are you sure want to Activate this Account?")) {
                    $.ajax({
                        url: 'controllers/deactivate_user1.php',
