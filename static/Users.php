                        ...
                        <?php if (!empty($booking)) {
                            foreach ($booking as $row) { ?>
                                <tr>
                                    ...
                                    <td><?= htmlspecialchars($row['Fullname'])   ?> <?= htmlspecialchars($row['middle'])   ?>  <?= htmlspecialchars($row['Lastname'])   ?></td>
                                  
								
								
                                    <td >
                                        <?= htmlspecialchars($row['Phone No']) ?>
                                    </td>
									<td >
                                    ...
                                    <td >
									<?php if($row['Status']== 1){ ?> 
									<a href="javascript:;" data-id="<?= $row['Customer_id']; ?>" class="text-secondary font-weight-bold text-xs actives" data-toggle="tooltip" title="Deactivate">
                                       
									<i class="align-middle me-2" data-feather="zap-off"></i>
									<?php }elseif($row['Status']== 0){ ?>
										<a href="javascript:;" data-id="<?= $row['Customer_id']; ?>" class="text-secondary font-weight-bold text-xs deactive" data-toggle="tooltip" title="Activate">
        ...
        function load_data() {
            $(document).on('click', '.actives', function() {
                ...
                if (confirm("Are you sure want to Deactivate this Account?")) {
                    $.ajax({
                        url: 'controllers/activate_user.php',
        ...
        function load_data() {
            $(document).on('click', '.deactive', function() {
                ...
                if (confirm("Are you sure want to Activate this Account?")) {
                    $.ajax({
                        url: 'controllers/deactivate_user.php',
