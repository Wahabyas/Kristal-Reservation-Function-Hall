...
<!--  -->
    ...
    $booking = $conn->fetchAll_BookingDeclined();
    ?>
                        ...
                        <?php if (!empty($booking)) {
                            foreach ($booking as $row) { ?>
								...
								<td><?= htmlspecialchars($row['code']) ?></td>
                                    ...
                                    <td >
										<?php if($row['Status']== 'Expired'){ ?>
									<a href="Expired.php?event=<?= $row['id']; ?>&event-name=<?php echo $row['events']; ?>" class="text-secondary font-weight-bold text-xs" data-toggle="tooltip" title="Expired">
									<i class="align-middle me-2" data-feather="mail"></i>
												</a>
												<?php }else{ ?>
												<a href="apology.php?event=<?= $row['id']; ?>&event-name=<?php echo $row['events']; ?>" class="text-secondary font-weight-bold text-xs" data-toggle="tooltip" title="Cancelled">
									<i class="align-middle me-2" data-feather="mail"></i>
												</a>
												<?php } ?>
                                    </td>
