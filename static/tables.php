		...
		<?php include('includes/header.php'); ?>
			...
			<main class="content">
				<div class="container-fluid p-0">
					...
					<h1 class="h3 mb-3"> All Booking Request of <strong>FUNCTION HALL RESERVATION AND BILLING SYSTEM</strong></h1>
...
<div id="response-container"></div>
					...
					<div class="row">
						<div class="col-12 col-lg-12 col-xxl-9 d-flex">
							<div class="card flex-fill">
								<div class="card-header">
									...
									<h5 class="card-title mb-0">Latest inquiries</h5>
								</div>
								<table class="table table-hover my-0">
									<thead>
										<tr>
											<th>Name</th>
											<th class="d-none d-xl-table-cell">Date of booking</th>
											<th class="d-none d-xl-table-cell">Date booked</th>
											<th>Status</th>
									...
									<tbody>
										<tr>
											...
											<td class="d-none d-md-table-cell"> delete or update</td>
										</tr>
						...
						<div class="col-12 col-lg-4 col-xxl-3 d-flex">
							<div class="card flex-fill w-100" hidden>
								<div class="card-header">
