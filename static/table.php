                        ...
                        <?php if (!empty($booking)) {
                            foreach ($booking as $row) { ?>
								...
								<td><?= htmlspecialchars($row['code']) ?></td>
                                    ...
                                    <td >
										<?php if($row['Status']!= 'Declined'){ ?>									<a href="edit_event.php?event=<?= $row['id']; ?>&event-name=<?php echo $row['events']; ?>&event-Duration=<?php echo $row['Duration']; ?>" class="text-secondary font-weight-bold text-xs" data-toggle="tooltip" title="Approve">
										<i class="align-middle me-2" data-feather="user-check"	title="Approve" ></i>
												</a>

												<a href="javascript:;" data-id="<?= $row['id']; ?>" class="text-secondary font-weight-bold text-xs disapprove" data-toggle="tooltip" title="Disapprove event">
												<i class="align-middle me-2" data-feather="user-x"></i>
												</a>
										<a href="javascript:;" data-id="<?= $row['id']; ?>" class="text-secondary font-weight-bold text-xs delete" data-toggle="tooltip" title="delete event">
        ...
        function load_data() {
            $(document).on('click', '.disapprove', function() {
                ...
                if (confirm("Are you sure want to Disapprove this Booking?")) {
                    $.ajax({
                        url: 'controllers/Disapprove.php',
